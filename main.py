...
def setup_cookies():
    ...
    try:
        ...
        for line in lines:
            ...
            if len(parts) >= 7:
                # Value kabhi kabhi multiple words ho sakti hai (rarely), isliye join karo
                # Lekin standard me value last hoti hai
                
                # Column 0-5 fix hote hain
                domain = parts[0]
                flag = parts[1].upper() # TRUE/FALSE capital hona chahiye
                path = parts[2]
